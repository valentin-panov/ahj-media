...
function container() {
  ...
  <div class="unit-container">
    ...
    <div class="container__footer">
      <form name="unitForm" novalidate class="form" id="newEntry">
        <input class="form__input" type="text" name="description" required placeholder="Введите текст заметки">
      </form
    </div>
  </div>
    `;
...
function unitForm() {
  ...
  formElement.innerHTML = `
    <form name="getManualGeo" novalidate class="form">
